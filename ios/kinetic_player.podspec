...
SGPlayer is built automatically on first `pod install` (may take 30-60 minutes).
                       DESC
  ...
  sgplayer_framework = 'Frameworks/SGPlayer.framework'
  ...
  s.prepare_command = <<-CMD
    ...
    if [ -d "#{sgplayer_framework}" ]; then
      ...
      echo "[kinetic_player] SGPlayer.framework not found - building automatically."
  ...
  s.source_files = 'kinetic_player/Sources/kinetic_player/**/*.{swift,h,m}'
  s.public_header_files = 'kinetic_player/Sources/kinetic_player/**/*.h'
